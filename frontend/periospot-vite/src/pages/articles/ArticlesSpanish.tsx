...
const sortOptions = [
  { value: "latest", label: "Recientes", icon: Clock },
...
const ArticlesSpanish = () => {
  ...
  const posts = useMemo(() => getPostsByLanguage("es"), []);
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-primary">Artículos en Español</span>
            </div>
            <h1 className="font-display text-4xl md:text-5xl font-semibold text-foreground mb-4">
              Blog
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Conocimientos expertos, casos clínicos y las últimas investigaciones en periodoncia e implantología.
            </p>
          </motion.div>
          ...
          {paginatedPosts.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {paginatedPosts.map((post, index) => (
                ...
                >
                  <Link to={`/articles/spanish/${post.slug}`} className="block">
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {formatReadTime(post.readTimeMinutes, "es")}
                        </span>
                      </div>
                    </div>
                  </Link>
            ...
            >
              <p className="text-muted-foreground text-lg">No se encontraron artículos con los criterios seleccionados.</p>
              <button
                onClick={() => {
                  setSearchQuery("");
