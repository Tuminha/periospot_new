...
const HERO_VIDEO_URL = import.meta.env.VITE_SUPABASE_URL 
  ? `${import.meta.env.VITE_SUPABASE_URL}/storage/v1/object/public/hero-videos/kling_20260102_Text_to_Video__Cinematic_2251_0.mp4`
  : null;
